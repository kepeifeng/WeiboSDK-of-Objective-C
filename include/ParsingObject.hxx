...
{
	class ParsingHandle;
    class WEIBO_SDK_API ParsingObjectCallback{};
...
//		typedef void (ParsingObjectCallback::*EnumAllSubCall)(const boost::shared_ptr<ParsingObject> object, void* usrData);
//		void enumAllSub(ParsingObjectCallback::EnumAllSubCall callback, void* usrData);
//        
